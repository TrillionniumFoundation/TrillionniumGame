...
inner=/tmp/trnm-world-qualify-v13c-inner.sh
...
new = 'compat="$control/tmp/world-plan-v4-v8-patch/apply-partition-compat-v2.py"\n'
if text.count(old) != 1:
...
printf 'TRNM_WORLD_V13C_COMPLETE_EXPORT=PASS\n'
