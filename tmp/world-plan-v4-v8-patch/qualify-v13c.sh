...
inner=/tmp/trnm-world-qualify-v13e-inner.sh
...
new = 'compat="$control/tmp/world-plan-v4-v8-patch/apply-partition-compat-v4.py"\n'
if text.count(old) != 1:
...
printf 'TRNM_WORLD_V13E_COMPLETE_EXPORT=PASS\n'
