...
/// In-process storage-list cursor representation.
///
/// The tuple binds `(actor, optional owner scope, last key)`. Public wire
/// adapters must encode and authenticate all three elements before accepting a
