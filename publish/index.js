...
const result = spawnSync('/usr/bin/python3', [
  path.join(process.env.GITHUB_WORKSPACE, 'tooling/diagnostic/scripts/upload-actions-artifact.py'),
  'trnm-review-v7-8fde7e81',
  path.join(process.env.RUNNER_TEMP, 'trnm-review-8fde7e81.zip'),
