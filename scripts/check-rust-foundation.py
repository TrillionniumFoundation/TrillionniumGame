...
EXPECTED_DEPENDENCIES: dict[str, dict[str, Any]] = {'crates/trnm-authority-core': {'trnm-contracts': {'path': '../trnm-contracts'}},
 ...
 'crates/trnm-persistence-runtime-policy': {'trnm-contracts': {'path': '../trnm-contracts'}},
 'crates/trnm-presence-core': {'trnm-contracts': {'path': '../trnm-contracts'}},
 'crates/trnm-presence-router-v2': {},
 'crates/trnm-query-core': {'trnm-contracts': {'path': '../trnm-contracts'}},
 'crates/trnm-realtime-wire': {},
 ...
 'crates/trnm-storage-nakama-version': {},
 'crates/trnm-token-core': {'trnm-contracts': {'path': '../trnm-contracts'}},
 'crates/trnm-token-crypto-provider': {'hmac': '=0.13.0',
                                        'sha2': '=0.11.0',
                                        'subtle': '=2.6.1',
                                        'zeroize': '=1.8.2'},
